  ...
  return (
    <div className="min-h-dvh bg-cream text-ink">
      ...
      <section className="grain relative overflow-hidden">
        ...
        {/* Decorative ribbon */}
        <div className="border-y border-ink/10 bg-maroon py-2.5">
          <p className="whitespace-nowrap text-center text-[11px] font-semibold uppercase tracking-[0.35em] text-cream/80">
            Class of 2026 · ANU · Sydney · Melbourne · UQ · UWA · Adelaide · Monash · UNSW · Class of 2026
          </p>
        </div>
      </section>
          ...
          <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {universities.map((u) => (
              <a
                ...
                className="group rounded-2xl border border-ink/10 bg-white p-4 transition-all hover:-translate-y-0.5 hover:border-maroon/40 hover:shadow-lg hover:shadow-maroon/10"
              >
      ...
      <section id="faq" className="scroll-mt-20 bg-blush">
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1fr_1.4fr] lg:py-20">
          ...
          <div className="divide-y divide-maroon/15">
            {FAQS.map((faq) => (
